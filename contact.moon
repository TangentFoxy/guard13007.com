    ...
    [chat_rules: "/chat/rules"]: =>
        ...
        @html ->
            ol ->
                ...
                li "Please refrain from using offensive language meant to provoke an argument with no constructive purpose.(Especially with people you are not too familiar with yet)"
                hr!
